...
func TestSendingToCastAddress(t *testing.T) {
	...
	require.Nil(t, a.BankKeeper.MintCoins(ctx, "evm", sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(10)))))
	require.Nil(t, a.BankKeeper.SendCoinsFromModuleToAccount(ctx, "evm", sourceAddr, sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(5)))))
	amt := sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(1)))
