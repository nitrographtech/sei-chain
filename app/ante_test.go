...
func (suite *AnteTestSuite) SetupTest(isCheckTx bool) {
	...
	initalBalance := sdk.Coins{sdk.NewInt64Coin("unos", 100000000000)}
...
func TestEvmAnteErrorHandler(t *testing.T) {
	...
	testkeeper.EVMTestApp.BankKeeper.AddCoins(ctx, addr, sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(100000000000))), true)
