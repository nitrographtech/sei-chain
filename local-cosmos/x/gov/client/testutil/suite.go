...
func (s *IntegrationTestSuite) TestCmdParams() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"voting_params":{"voting_period":"172800000000000"},"tally_params":{"quorum":"0.334000000000000000","threshold":"0.500000000000000000","veto_threshold":"0.334000000000000000"},"deposit_params":{"min_deposit":[{"denom":"unos","amount":"10000000"}],"max_deposit_period":"172800000000000"}, "min_expedited_deposit":[{"denom":"unos","amount":"20000000"}]}`,
		},
		{
			"text output",
			[]string{},
...
func (s *IntegrationTestSuite) TestCmdParam() {
	...
	testCases := []struct {
		...
		},
		{
			...
			`{"min_deposit":[{"denom":"unos","amount":"10000000"}],"max_deposit_period":"172800000000000", "min_expedited_deposit":[{"denom":"unos","amount":"20000000"}]}`,
		},
	}
