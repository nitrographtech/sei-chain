...
func TestMigrate(t *testing.T) {
	...
	coins := sdk.NewCoins(sdk.NewInt64Coin("unos", 50))
	...
	supply := sdk.NewCoins(sdk.NewInt64Coin("unos", 1000))
	...
	expected := `{"params":{"send_enabled":[],"default_send_enabled":true},"balances":[{"address":"cosmos1xxkueklal9vejv9unqu80w9vptyepfa95pd53u","coins":[{"denom":"unos","amount":"50"}]},{"address":"cosmos15v50ymp6n5dn73erkqtmq0u8adpl8d3ujv2e74","coins":[{"denom":"unos","amount":"50"}]}],"supply":[{"denom":"unos","amount":"1000"}],"denom_metadata":[],"wei_balances":[]}`
