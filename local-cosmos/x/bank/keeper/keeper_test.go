...
func (suite *IntegrationTestSuite) TestSpendableCoins() {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 100))
	delCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 50))
...
func (suite *IntegrationTestSuite) TestVestingAccountSend() {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 100))
	sendCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 50))
...
func (suite *IntegrationTestSuite) TestPeriodicVestingAccountSend() {
	...
	periods := vesting.Periods{
		vesting.Period{Length: int64(12 * 60 * 60), Amount: sdk.Coins{sdk.NewInt64Coin("unos", 50)}},
		vesting.Period{Length: int64(6 * 60 * 60), Amount: sdk.Coins{sdk.NewInt64Coin("unos", 25)}},
		vesting.Period{Length: int64(6 * 60 * 60), Amount: sdk.Coins{sdk.NewInt64Coin("unos", 25)}},
	}
...
func (suite *IntegrationTestSuite) TestDelegateCoinsFromAccountToModule() {
	...
	origCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 100))
	delCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 50))
	undelCoins := sdk.NewCoins(sdk.NewInt64Coin("unos", 20))
...
func (suite *IntegrationTestSuite) TestCanSendTo() {
	...
	suite.Require().NoError(simapp.FundAccount(app.BankKeeper, ctx, sourceAddr, sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(100)))))
	...
	amt := sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(10)))
