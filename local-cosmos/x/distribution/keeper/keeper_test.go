...
func TestWithdrawValidatorCommission(t *testing.T) {
	...
	valCommission := sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("unos", sdk.NewDec(3).Quo(sdk.NewDec(2))),
	}
	...
	coins := sdk.NewCoins(sdk.NewCoin("mytoken", sdk.NewInt(2)), sdk.NewCoin("unos", sdk.NewInt(2)))
	...
	expCoins := sdk.NewCoins(sdk.NewCoin("unos", expTokens))
	...
	require.Equal(t, sdk.NewCoins(
		...
		sdk.NewCoin("unos", expTokens.AddRaw(1)),
	), balance)
	...
	require.Equal(t, sdk.DecCoins{
		...
		sdk.NewDecCoinFromDec("unos", sdk.NewDec(1).Quo(sdk.NewDec(2))),
	}, remainder)
...
func TestFundCommunityPool(t *testing.T) {
	...
	amount := sdk.NewCoins(sdk.NewInt64Coin("unos", 100))
