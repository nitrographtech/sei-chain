...
func (s *IntegrationTestSuite) TestGetCmdQueryValidatorOutstandingRewards() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			`{"rewards":[{"denom":"unos","amount":"1164.240000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryValidatorCommission() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			`{"commission":[{"denom":"unos","amount":"464.520000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryDelegatorRewards() {
	...
	testCases := []struct {
		...
		},
		{
			...
			false,
			fmt.Sprintf(`{"rewards":[{"validator_address":"%s","reward":[{"denom":"unos","amount":"387.100000000000000000"}]}],"total":[{"denom":"unos","amount":"387.100000000000000000"}]}`, valAddr.String()),
		},
		{
			...
			false,
			`{"rewards":[{"denom":"unos","amount":"387.100000000000000000"}]}`,
		},
		{
			"text output",
			[]string{
...
func (s *IntegrationTestSuite) TestGetCmdQueryCommunityPool() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"pool":[{"denom":"unos","amount":"4.740000000000000000"}]}`,
		},
		{
			"text output",
