...
func (s *IntegrationTestSuite) TestGetCmdQueryParams() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			`{"mint_denom":"unos","inflation_rate_change":"0.130000000000000000","inflation_max":"1.000000000000000000","inflation_min":"1.000000000000000000","goal_bonded":"0.670000000000000000","blocks_per_year":"6311520"}`,
		},
		{
			"text output",
