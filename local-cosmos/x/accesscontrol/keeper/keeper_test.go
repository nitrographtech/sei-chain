...
func TestInvalidGetMessageDependencies(t *testing.T) {
	...
	stakingUndelegate := stakingtypes.MsgUndelegate{
		...
		Amount:           sdk.Coin{Denom: "unos", Amount: sdk.NewInt(10)},
	}
...
func TestBuildDependencyDag(t *testing.T) {
	...
	// setup test txs
	msgs := []sdk.Msg{
		banktypes.NewMsgSend(accounts[0], accounts[1], sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(1)))),
	}
...
func TestBuildDependencyDag_GovPropMessage(t *testing.T) {
	...
	govMsg, _ := govtypes.NewMsgSubmitProposal(
		...
		sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(1))),
		accounts[0],
	)
	// setup test txs
	msgs := []sdk.Msg{govMsg}
...
func TestBuildDependencyDag_MultipleTransactions(t *testing.T) {
	...
	msgs2 := []sdk.Msg{
		banktypes.NewMsgSend(accounts[1], accounts[2], sdk.NewCoins(sdk.NewCoin("unos", sdk.NewInt(1)))),
	}
...
func (suite *KeeperTestSuite) TestMessageDependencies() {
	...
	bankSendMsg := banktypes.MsgSend{
		...
		Amount:      sdk.NewCoins(sdk.Coin{Denom: "unos", Amount: sdk.NewInt(10)}),
	}
