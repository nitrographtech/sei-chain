...
func (s *decCoinTestSuite) TestParseDecCoins() {
	testCases := []struct {
		...
		{"", nil, false},
		{"4usei", sdk.DecCoins{sdk.NewDecCoinFromDec("unos", sdk.NewDecFromInt(sdk.NewInt(4)))}, false},
		{"5.5atom,4usei", sdk.DecCoins{
			sdk.NewDecCoinFromDec("atom", sdk.NewDecWithPrec(5500000000000000000, sdk.Precision)),
			sdk.NewDecCoinFromDec("unos", sdk.NewDec(4)),
		}, false},
		{"0.0usei", sdk.DecCoins{}, false}, // remove zero coins
		{"10.0btc,1.0atom,20.0btc", nil, true},
		{
			"0.004usei",
			sdk.DecCoins{sdk.NewDecCoinFromDec("unos", sdk.NewDecWithPrec(4000000000000000, sdk.Precision))},
			false,
		},
		{
			"0.004usei",
		...
		},
		{
			...
			sdk.DecCoins{
				...
				sdk.NewDecCoinFromDec("unos", sdk.NewDecWithPrec(4000000000000000, sdk.Precision)),
			},
			false,
		},
